...
class UserInit:
    def __init__(self):
        self.req = account.SetUserProfileReqMsg();
        self.key = 99999989;
        pass;
    ...
    def mock(self, uid, session):
        ...
        self.req.avada_url = "avada_url/test" + str(random.randint(1,2399));
        self.req.avada_size = "1000x434";
        self.req.usr_name = "usr_name";
    ...
    def Deserialize(self, responseStr):
        self.resp = account.SetUserProfileRespMsg()
...
if __name__ == '__main__':
    if (len(sys.argv) != 3):
        print "Usage: mock_user_set_prof.py <uid> <session_token>";
